...
def classwise_IoU_triangles(preds, targets, num_classes):
    # preds has shape (num_points, num_classes)
    # targets has shape (num_points,)
...
def triangle_accuracy(preds, targets, ignore_index=None):
    # preds has shape (num_points, num_classes)
    # targets has shape (num_points,)
...
def classwise_triangle_accuracy(preds, targets, ignore_index=None):
    # preds has shape (num_points, )
    # targets has shape (num_points,)
